...
// 
// Al hacer clic en el logo, vuelve a la sección de inicio y actualiza menú
document.querySelector(".logo a").addEventListener("click", function () {
  const sectionIndex = this.getAttribute("data-section-index");
  // Elimina back-section previa
  removeBackSection();
  // Agrega la clase "back-section" a la actual activa (antes de ir a home)
  for (let i = 0; i < totalNavList; i++) {
  ...
  // Agrega clase active al botón del menú correspondiente (Inicio)
  this.classList.add("active");
